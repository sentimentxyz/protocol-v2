...
contract DeployHyperliquidOracle is BaseScript {
    ...
    uint public immutable assetIndex = 125;
    uint public immutable assetAmtScale = 1;
    uint public immutable assetPriceScale = 1e12;
    ...
    function run() public {
        ...
        uint price = oracle.getValueInEth(asset, 1e18);
