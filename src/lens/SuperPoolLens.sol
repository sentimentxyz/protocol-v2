...
contract SuperPoolLens {
    ...
    function getPoolDepositData(address superPool, uint256 poolId)
        public
        view
    ...
    function getUserMultiDepositData(address user, address[] calldata superPools)
        public
        view
    ...
    function getUserDepositData(address user, address _superPool)
        public
        view
